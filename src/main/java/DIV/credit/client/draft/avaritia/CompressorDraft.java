...
public final class CompressorDraft implements RecipeDraft {
    ...
    private static final ResourceLocation SINGULARITY_ID = ResourceLocation.fromNamespaceAndPath("avaritia", "singularity");
    ...
    public net.minecraft.world.item.crafting.Recipe<?> toRecipeInstance() {
        ...
        net.minecraft.resources.ResourceLocation id = ResourceLocation.fromNamespaceAndPath(Credit.MODID, "draft/compressor");
    ...
    public String emit(String recipeId) {
        ...
        // 1.21: forge nbt field は廃止。 DataComponents は item id に [comp=val] を埋め込む (Singularity の Material 等)。
        String resComps = DIV.credit.client.draft.RecipeDraft.componentsSuffix(resIt.stack());
        sb.append("        result: { item: '").append(escapeNbtForSingleQuote(resRl + resComps)).append("'");
