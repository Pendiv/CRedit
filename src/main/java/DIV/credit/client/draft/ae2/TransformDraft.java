...
public final class TransformDraft implements RecipeDraft {
    ...
    public net.minecraft.world.item.crafting.Recipe<?> toRecipeInstance() {
        ...
        net.minecraft.resources.ResourceLocation id =
            net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(Credit.MODID, "draft/transform");
        ...
        if (!isExplosion && fluidTag != null && !fluidTag.isEmpty()) {
            try { fluidRl = net.minecraft.resources.ResourceLocation.parse(fluidTag); }
