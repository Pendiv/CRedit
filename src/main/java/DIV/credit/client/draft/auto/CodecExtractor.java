...
public final class CodecExtractor {
    ...
    private static Codec<Recipe<?>> locateCodec(RecipeSerializer<?> ser) {
        ...
        try {
            ...
            if (o instanceof MapCodec<?> mc) return (Codec<Recipe<?>>) mc.codec();  // 1.21: RecipeSerializer.codec() は MapCodec
        ...
        while (cls != null && cls != Object.class) {
            try {
                ...
                Object o = f.get(null);
                if (o instanceof MapCodec<?> mc) return (Codec<Recipe<?>>) mc.codec();  // 1.21: MapCodec も許容
                if (o instanceof Codec<?> c) return (Codec<Recipe<?>>) c;
