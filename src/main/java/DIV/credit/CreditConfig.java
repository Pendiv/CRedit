...
public final class CreditConfig {
    ...
    public static final ModConfigSpec.ConfigValue<String> DUMP_ROOT;
    public static final ModConfigSpec.IntValue FLUID_DEFAULT_AMOUNT;
    public static final ModConfigSpec.IntValue GAS_DEFAULT_AMOUNT;
    public static final ModConfigSpec.IntValue INFUSION_DEFAULT_AMOUNT;
    public static final ModConfigSpec.EnumValue<EditPersistence> EDIT_PERSISTENCE;
    public static final ModConfigSpec.BooleanValue CRAFTING_SHARE_SLOTS;
    public static final ModConfigSpec.BooleanValue UNDO_ENABLED;

    // ─── v2.2.0 immediate apply (commit/push 貫通) ───
    public static final ModConfigSpec.BooleanValue IMMEDIATE_APPLY_MASTER;
    public static final ModConfigSpec.BooleanValue IMMEDIATE_APPLY_ADD;
    public static final ModConfigSpec.BooleanValue IMMEDIATE_APPLY_EDIT;
    public static final ModConfigSpec.BooleanValue IMMEDIATE_APPLY_DELETE;

    // ─── v2.2.0 history retention + push 後 reload ───
    public static final ModConfigSpec.EnumValue<HistoryMax> HISTORY_MAX;
    public static final ModConfigSpec.BooleanValue AUTO_RELOAD_AFTER_PUSH;

    // ─── v3.10 push payload (= preview 過去世代用) ───
    public static final ModConfigSpec.IntValue HISTORY_MAX_PUSH_PAYLOAD_GENERATIONS;
    public static final ModConfigSpec.IntValue HISTORY_MAX_PUSH_PAYLOAD_SIZE_KB;

    // ─── v2.2.2 modid prefix omitted commands ───
    public static final ModConfigSpec.BooleanValue OMIT_MODID_PREFIX;

    // ─── v3.0.1: 短縮コマンド個別 on/off (master = OMIT_MODID_PREFIX) ───
    public static final ModConfigSpec.BooleanValue SHORT_CMD_PUSH;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_COMMIT;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_HISTORY;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_SETTING;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_IMPORT;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_RECONSTRUCTION;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_PREVIEW;
    public static final ModConfigSpec.BooleanValue SHORT_CMD_STATUS;

    // ─── v3.0.1: keybind / clipboard (= BuilderScreen 内挙動の便利機能) ───
    public static final ModConfigSpec.BooleanValue SPECIAL_KEYBINDS_ENABLED;
    public static final ModConfigSpec.BooleanValue QUICK_ADD_HOTBAR;
    public static final ModConfigSpec.BooleanValue CLIPBOARD_ENABLED;
    public static final ModConfigSpec.BooleanValue CLIPBOARD_MULTI;
    public static final ModConfigSpec.EnumValue<ClipboardPersistence> CLIPBOARD_PERSISTENCE;

    // ─── v3.2.x: GT / Create 確率 output の初期値 (右クリで CFG セットした時の default) ───
    public static final ModConfigSpec.IntValue CHANCE_DEFAULT_MILLE;
    public static final ModConfigSpec.IntValue CHANCE_DEFAULT_BOOST;

    // ─── v2.0.9 edit mode → category 切替時にグリッド内容保持するか ───
    public static final ModConfigSpec.BooleanValue PRESERVE_EDIT_GRID_ON_SWITCH;

    // ─── v2.1.2 出力ファイル構造の切替 ───
    public static final ModConfigSpec.BooleanValue UNIFIED_EDIT_FILES;

    // ─── v3.4.x: EMI viewer integration on/off (= 在時 only 有効、 runtime 反映) ───
    public static final ModConfigSpec.BooleanValue EMI_VIEWER_INTEGRATION;
    ...
    public static boolean isEmiIntegrationEnabled() {
        if (!net.neoforged.fml.ModList.get().isLoaded("emi")) return false;
